...
export default function Certificates() {
  return (
    <div className="flex flex-row gap-[7rem] px-[18rem] py-[3rem] mt-[5rem]  max-[1500px]:px-[6rem] max-[700px]:px-[3rem] items-center bg-[url('/background.png')] max-[1000px]:flex-col max-[700px]:gap-[2rem] ">
